define([
  ...
  var ScheduleSelect = function(c) {
    ...
    this.select0LocalFileIndex = 99;
    this.select1LocalFileIndex = 99;
  ...
  ScheduleSelect.prototype.fillSelects = function() {
    this.select0.add(new Option(ScheduleSelectOptions.PLEASE_SELECT));
    this.select1.add(new Option(ScheduleSelectOptions.PLEASE_SELECT));
